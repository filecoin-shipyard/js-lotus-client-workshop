  ...
  return (
    ...
    >
      ...
      <div style={{ textAlign: 'left', fontSize: '80%'}}>
        <div>
          CID: <span style={{ fontSize: '70%' }}>{cid}<br /></span>
          <span style={{ fontSize: '70%' }}>Generated by hashing your file, same as IPFS CID<br /><br /></span>
        </div>
        <div>
          Wallet address:{' '}
          <span style={{ fontSize: '50%' }}>{defaultWalletAddress}</span>
        </div>
        <div>Balance: {typeof balance !== 'undefined' && balance.toFil()} FIL</div>
      </div>
